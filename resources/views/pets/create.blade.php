                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="species" id="species" 
                                    ...
                                    <option value="roedor" {{ old('species') == 'roedor' ? 'selected' : '' }}>Roedor</option>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="medical_history" id="medical_history" rows="4"
                                          class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                          placeholder="Información médica relevante, alergias, tratamientos, etc.">{{ old('medical_history') }}</textarea>
